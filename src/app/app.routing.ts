...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/exercise'
    {path: '', pathMatch: 'full', redirectTo: 'exercise'},

    // Redirect signed in user to the '/exercise'
    //
    // After the user signs in, the sign in page will redirect the user to the 'signed-in-redirect'
    // path. Below is another redirection for that path to redirect the user to the desired
    // location. This is a small convenience to keep all main routes together here on this file.
    {path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'exercise'},
    ...
    // Admin routes
    {
        ...
        children: [
            {
                path: 'exercise',
                loadChildren: () => import('app/modules/admin/exercise/exercise.module').then(m => m.ExerciseModule)
            },
            {
                path: 'student',
                loadChildren: () => import('app/modules/admin/student/student.module').then(m => m.StudentModule)
            },
            {
                path: 'workout',
                loadChildren: () => import('app/modules/admin/workout/workout.module').then(m => m.WorkoutModule)
            },
        ]
    }
];
